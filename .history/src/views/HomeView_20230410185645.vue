<template xmlns="http://www.w3.org/1999/html">
  ...
  <section class="EventManagement" data-scroll-section id="home-news-sec">
    ...
    <div class="text" data-scroll data-scroll-speed="2" data-scroll-position="bottom">
      ...
      <!-- <h1 class="fsh1 textAnimStart-container" data-scroll>
        <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Event</span></p>
          <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Management</span></p>
      </h1> -->
      <article class="title fsh1 txtWhite">
          <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Event</span></p>
          <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Managem</span></p>
        </article>
