  ...
  <section class="check containerHero" id="containerHero" data-scroll-section>
    ...
    <div class="background" @mouseenter="follow('Scroll')" @mouseleave="unfollow()">
      <picture data-scroll data-scroll-repeat="true" data-scroll-offset="50%, 50%">
        <img src="@/assets/background/Meinthesun.png" class="desktop-only" alt="" data-scroll data-scroll-speed="-3" data-scroll-position="top">
        <img src="@/assets/background/Meinthesunxnxx.png" class="mobile-only"  alt="" data-scroll data-scroll-speed="-3" data-scroll-position="top">
      </picture>
    </div>
