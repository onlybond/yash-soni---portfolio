<template xmlns="http://www.w3.org/1999/html">
  ...
  <section class="container sectionHome2" data-scroll-section>
    ...
    <section class="imagesSection__grid" data-scroll>
      ...
      <image-video-on-hover @mouseenter="follow('view')" @mouseleave="unfollow()" class="two" image-link="images_sections/2" id-unique="two" title="Ottografie"
        text="Immersive photography portfolio" data-scroll data-scroll-speed="1.3"></image-video-on-hover>
      <image-video-on-hover @mouseenter="follow('view')" @mouseleave="unfollow()" class="three" image-link="images_sections/3" id-unique="three" title="Rino & Pelle"
        text="Effortless chic lifestyle" data-scroll data-scroll-speed="1.15"></image-video-on-hover>
      <image-video-on-hover @mouseenter="follow('view')" @mouseleave="unfollow()" class="four" image-link="images_sections/4" id-unique="four" title="Aebele Interiors"
