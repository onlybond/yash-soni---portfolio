<template xmlns="http://www.w3.org/1999/html">
  ...
  <section class="containerHero" id="containerHero" data-scroll-section ref="section1">
  ...
  <section class="container sectionHome2" data-scroll-section ref="section2">
  ...
  <section class=" container sectionHome3" data-scroll-section @mouseenter="follow('Wait a sec')" @mouseleave="unfollow()"
    ref="section">
  ...
  <section class=" container EventManagement" data-scroll-section id="home-news-sec" ref=section4>
...
export default {
  ...
  mounted() {
    ...
    const observer2 = new IntersectionObserver(entries => {
      entries.forEach(entry => {
        if (entry.classList.contains('is-inview')) {
          const color = entry.target.classList[0];
          console.log(color);
        }
      });
    }, options);
