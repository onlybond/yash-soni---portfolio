<template xmlns="http://www.w3.org/1999/html">
  ...
  <section class="containerHero" id="containerHero" data-scroll-section>

    <div class="background" @mouseenter="follow('Scroll')" @mouseleave="unfollow()" >
      <picture data-scroll data-scroll-repeat="true" data-scroll-offset="50%, 50%">
        <img src="@/assets/background/BG2.png" alt="" data-scroll data-scroll-speed="-3" <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="1562.000000pt" height="1562.000000pt" viewBox="0 0 1562.000000 1562.000000"
 preserveAspectRatio="xMidYMid meet">

<g transform="translate(0.000000,1562.000000) scale(0.100000,-0.100000)"
fill="#000000" stroke="none">
</g>
</svg>>
        <img src="@/assets/background/ysh2.png" alt="" data-scroll data-scroll-speed="-3" data-scroll-position="top">
      </picture>
    </div>
    <section class="container" id="hero-target" data-scroll data-scroll-position="top">
        ...
        <div class="textHero" >
          <article class="intro fsh3 txtWhite" >
            <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Intrigued by beauty, fascinated by technology</span></p>
            <p class="textAnimStart-container" data-scroll><span class="textAnimStart">and fuelled with an everlasting devotion to digital</span></p>
            <p class="textAnimStart-container" data-scroll><span class="textAnimStart">craftsmanship and meaningful aesthetics.</span></p>
          </article>

          <article class="title fsh1 txtWhite" >
            <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Digital</span></p>
            <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Design</span></p>
            <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Experience</span></p>
          </article>


        </div>
          <article class="underTitle" >
            <p class="paragraphe fsh3 txtWhite" >White-glove digital experiences, engaging content and impactful design solutions that inspire, affect and delight. We carefully wrap emotionally rich aesthetics around strategic concepts to deliver award-winning digital design that exceeds expectations.</p>

            <arrow-anim text="The studio" main-color="White" arrow-color="Black"></arrow-anim>

            <nav class="underTitleNav fsText txtWhite" >
              <ul>
                <li class="anim"><a href="">Work</a></li>
                <li class="anim"><a href="">Studio</a></li>
                <li class="anim"><a href="">News</a></li>
                <li class="anim"><a href="">Contact</a></li>

              </ul>

            </nav>

            <ul class="contact fsText txtWhite" >
              <li class="anim" data-scroll><a href="">louis.lasserre33@gmail.com</a></li>
              <li class="anim" data-scroll><a href="">06 15 60 70 07</a></li>
            </ul>
  ...
  <section class="container sectionHome2" data-scroll-section>
    ...
    <section class="imagesSection__grid" data-scroll>
      <article class="imagesSectionText txtBlack" data-scroll>
        ...
        <p class="fsh3" data-scroll>Highlights of cases that we passionately built with forward-thinking clients and friends over the years.</p>
      </article>

      <image-video-on-hover @mouseenter="follow('view')" @mouseleave="unfollow()" class="one" image-link="images_sections/1" id-unique="one" title="Ali Ali" text="Unique director’s portfolio" data-scroll></image-video-on-hover>
      <image-video-on-hover class="two" image-link="images_sections/2" id-unique="two" title="Ottografie" text="Immersive photography portfolio" data-scroll data-scroll-speed="1.3"></image-video-on-hover>
      <image-video-on-hover class="three" image-link="images_sections/3" id-unique="three" title="Rino & Pelle" text="Effortless chic lifestyle" data-scroll data-scroll-speed="1.15"></image-video-on-hover>
      <image-video-on-hover class="four" image-link="images_sections/4" id-unique="four" title="Aebele Interiors" text="Luxurious design experience" data-scroll data-scroll-speed="-1.4"></image-video-on-hover>


      <arrow-anim class="flechePhotos" text="Browse all work" main-color="Black" arrow-color="White"></arrow-anim>
    </section>
  </section>
  ...
  <section class="screenSection videoSec txtWhite" data-scroll-section data-scroll-call="videoSec">
    <section class="bgBlack" data-scroll data-scroll-target=".videoSec" data-scroll-sticky :data-scroll-offset="videoSecOffset" @mouseenter="follow('Play')" @mouseleave="unfollow()">
      ...
      <h2 class="flex videoSecText" data-scroll>
        <div class="fsh2" id="videoSecTextG">Play</div>
        <div class="fsh2" id="videoSecTextD">Reel</div>
      </h2>

      <p class="fsText txtWhite" data-scroll>Our work is best experienced in motion. Don’t forget to put on your headphones.</p>
    </section>

  </section>
  <section class="spreadTheNewsSec" data-scroll-section id="home-news-sec">
    ...
    <ul data-scroll data-scroll-speed="-1" data-scroll-position="top">
      ...
      <li class="media two" data-scroll data-scroll-direction="horizontal" data-scroll-speed="0.75" data-scroll-target="#home-news-sec">
        <video playsinline="" loop="loop" muted="muted" autoplay>
          <source src="@/assets/background/spreadTheNews/home-news-diesel-be-a-follower.mp4" type="video/mp4" data-v-4a179df6="">
        </video>
      </li>
    ...
    <div class="text txtBlack" data-scroll data-scroll-speed="2" data-scroll-position="bottom">
      <star-text text="In the media" color="Black" data-scroll></star-text>
      <h1 class="fsh2 flex flexColumn letter-spacing-h1" data-scroll>
        <span data-scroll>Spread</span>
        <span data-scroll>the News</span>
      </h1>
      <p class="fsh3" data-scroll>Find out more about our work on these leading design and technology platforms</p>
      <arrow-anim text="Browse all news" main-color="Black" arrow-color="White" data-scroll></arrow-anim>
  ...
  mounted() {
    ...
    scroll.on("scroll", (e) =>{
      ...
      if (e.scroll.y > 95 && this.hambOn == false) {// we show the hamburger
        ...
        gsap.set('.pageHeader', {justifyContent: "flex-end", delay: 0.3})
