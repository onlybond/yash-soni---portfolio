<template xmlns="http://www.w3.org/1999/html">
  ...
  <section class="check sectionHome2" data-scroll-section>
  ...
  <section class="check sectionHome3" data-scroll-section @mouseenter="follow('Wait a sec')" @mouseleave="unfollow()" ref="section">
  ...
  <section class="check EventManagement" data-scroll-section id="home-news-sec">
...
export default {
  ...
  computed:{
    logo2Src() {
      ...
      if (lastSection.style.backgroundColor === 'white') {
        return '@/assets/logo-black.png';
      }
      return '@/assets/logo-w.png';
    },
  },
  mounted() {
