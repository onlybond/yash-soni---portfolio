    ...
    <section class="container" id="hero-target" data-scroll data-scroll-position="top">
        ...
        <div class="textHero" >
          ...
          <article class="title fsh1 txtWhite" >
            <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Creative</span></p>
            <p class="textAnimStart-container" data-scroll><span class="textAnimStart">Director</span></p>
