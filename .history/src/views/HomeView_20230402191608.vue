  ...
  <section class="containerHero" id="containerHero" data-scroll-section>
    ...
    <div class="background" @mouseenter="follow('Scroll')" @mouseleave="unfollow()">
      <picture data-scroll data-scroll-repeat="true" data-scroll-offset="50%, 50%">
        <img src="@/assets/background/Meinthesun.png" alt="" data-scroll data-scroll-speed="-3"
  ...
  <section class="container sectionHome2" data-scroll-section>
    ...
    <section class="imagesSection__grid" data-scroll>
      ...
      <image-video-on-hover @mouseenter="follow('view')" @mouseleave="unfollow()" class="one"
        image-link="images_sections/1" id-unique="one" title="Ali Ali" text="Unique director’s portfolio"
        data-scroll></image-video-on-hover>
      <image-video-on-hover class="two" image-link="images_sections/2" id-unique="two" title="Ottografie"
        text="Immersive photography portfolio" data-scroll data-scroll-speed="1.3"></image-video-on-hover>
      <image-video-on-hover class="three" image-link="images_sections/3" id-unique="three" title="Rino & Pelle"
        text="Effortless chic lifestyle" data-scroll data-scroll-speed="1.15"></image-video-on-hover>
      <image-video-on-hover class="four" image-link="images_sections/4" id-unique="four" title="Aebele Interiors"
        text="Luxurious design experience" data-scroll data-scroll-speed="-1.4"></image-video-on-hover>
      <image-video-on-hover class="three" image-link="images_sections/3" id-unique="six" title="Rino & Pelle"
        text="Effortless chic lifestyle" data-scroll data-scroll-speed="1.25"></image-video-on-hover>
      <image-video-on-hover class="three" image-link="images_sections/3" id-unique="six" title="Rino & Pelle"
        text="Effortless chic lifestyle" data-scroll data-scroll-speed="1.25"></image-video-on-hover>
  ...
  <section class="sectionHome3" data-scroll-section ref="section">
    <div class="edu-title" data-scroll>
      ...
      <div class="title-container" data-scroll>
        <h3 class="title" data-scroll>Education</h3>
        <h3 class="title" data-scroll>&amp; Experience</h3>
      </div>
    </div>
