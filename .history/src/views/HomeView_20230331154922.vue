<template xmlns="http://www.w3.org/1999/html">
    ...
    <section class="container" id="hero-target" data-scroll data-scroll-position="top">
        ...
        <div class="textHero" >
          ...
          <article class="underTitle" >
            <p class="paragraphe fsh3 txtWhite" >Hi, I am a self made Graphic Designer and have been exploring my interests in Multimedia Design via my degree in Multimedia and Animation.</p>
          </article>
  ...
  <section class="container sectionHome2" data-scroll-section>
    ...
    <section class="imagesSection__grid" data-scroll>
      ...
      <image-video-on-hover class="two" image-link="images_sections/2" id-unique="five" title="Ottografie" text="Immersive photography portfolio" data-scroll data-scroll-speed="1"></image-video-on-hover>
      <image-video-on-hover class="three" image-link="images_sections/3" id-unique="six" title="Rino & Pelle" text="Effortless chic lifestyle" data-scroll data-scroll-speed="1.25"></image-video-on-hover>
      <image-video-on-hover class="four" image-link="images_sections/4" id-unique="seven" title="Aebele Interiors" text="Luxurious design experience" data-scroll data-scroll-speed="-1.5"></image-video-on-hover>
  ...
  <section class="spreadTheNewsSec" data-scroll-section id="home-news-sec">
    ...
    <ul data-scroll data-scroll-speed="-1" data-scroll-position="top">
      ...
      <li class="media five" data-scroll data-scroll-direction="horizontal" data-scroll-speed="-1" data-scroll-target="#home-news-sec">
        <img loading="lazy" src="@/assets/background/spreadTheNews/home-news-25.jpeg" alt="" >
      </li>
    </ul>
