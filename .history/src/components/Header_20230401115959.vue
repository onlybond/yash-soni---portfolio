<template>
  <header class="pageHeader flex-bwn" style="justify-content: space-between;">
    ...
    <div class="textAnimStart-container stateScroll" :class="{ hidden,flex-bwn: !headerHidden }">
      <a href="/">
        <img class="anim logo" src="@/assets/logo2.png" alt="" />
      </a>
    </div>
