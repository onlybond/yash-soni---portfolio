<template>
  <header class="pageHeader">
    <div class="textAnimStart-container stateInit" v-if="!hambMenuOn">
        <a href="/">
          <img class="anim logo textAnimStart" src="@/assets/" alt="" />
        </a>
    </div>
    <div class="textAnimStart-container stateInit" v-else>
        <a href="/">
          <img class="anim logo textAnimStart" src=logo alt="" />
        </a>
    </div>
