<template>
  <header class="pageHeader">
    <div class="textAnimStart-container stateInit">
      <span>
        <a href="/">
        <img class="anim logo textAnimStart" :src="logoSrc" alt="" />
        </a>
      </span>
    </div>
...
// function logo() {
//   if (this.hambMenuOn) {
//     return <img class="anim logo textAnimStart" src="@/assets/logo2.png" alt="" />;
//   } else {
//     return <img class="anim logo textAnimStart" src="@/assets/logo.png" alt="" />;
//   }
// }
computed: {
    function logoSrc() {
      return this.hambMenuOn ? "@/assets/logo2.png" : "@/assets/logo.png";
    }
    }
export default {
  name: "Header",
