<template>
  <header class="pageHeader">
    <div class="textAnimStart-container stateInit">
        <span>
      <a href="/">
        <img class=" anim logo textAnimStart" :src="hambMenuOn ? '@/assets/logo2.png' : '@/assets/logo.png'" alt="" />
      </a>
        </span>
    </div>
...
export default {
  ...
  computed: {
    logoImage() {
      return this.hambMenuOn ? require('@/assets/logo2.png') : require('@/assets/logo.png');
    },
  },
  methods: {
    hambClick: function () {
