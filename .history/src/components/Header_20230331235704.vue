<template>
  <header class="pageHeader">
    <div class="textAnimStart-container stateInit">
        <span>
      <a href="/">
        <img class=" anim logo textAnimStart" :src="hambMenuOn ? require('@/assets/logo2.png') : require('@/assets/logo. alt="" />
        <img class=" anim logo textAnimStart" :src="hambMenuOn ? require('@/assets/logo2.png') : require('@/assets/logo.png')" alt="" />
      </a>
        </span>
    </div>
