<template>
  <header class="pageHeader" :class = "{flexbwn : this.headerHidden}">
    ...
    <div class="textAnimStart-container stateScroll" :class="{ hidden: !headerHidden }">
      <a href="/">
        <img class="anim logo2" src="@/assets/logo2.png" alt="" />
      </a>
    </div>
    <nav class="fsText txtWhite">
      <ul class="stateInit">
        <li class="anim textAnimStart-container">
          <a class="textAnimStart" href="#work">Work</a>
        </li>
        <li class="anim textAnimStart-container">
          <a class="textAnimStart" href="#experience">Studio</a>
        </li>
        <li class="anim textAnimStart-container">
          <a class="textAnimStart" href="#experience">News</a>
        </li>
        <li class="anim textAnimStart-container">
          <a class="textAnimStart" href="#contact">Contact</a>
        </li>
      </ul>
      <div  class="hambContainer stateScroll flex">
        <div class="hamb">
